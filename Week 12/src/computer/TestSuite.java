...
public class TestSuite extends Utility {
    ...
    public void verifyProductAddedToShoppingCartSuccessFully() throws InterruptedException {
        ...
        driver.findElement(By.xpath("//input[@id='BillingNewAddress_FirstName']")).sendKeys("Mahesh");
        driver.findElement(By.xpath("//input[@id='BillingNewAddress_LastName']")).sendKeys("Hirpara");
        driver.findElement(By.xpath("//input[@id='BillingNewAddress_Email']")).sendKeys("mack07@gmail.com");
        ...
        driver.findElement(By.xpath("//input[@id='BillingNewAddress_City']")).sendKeys("Ahmedabad");
        driver.findElement(By.xpath("//input[@id='BillingNewAddress_Address1']")).sendKeys("Temp house London");
